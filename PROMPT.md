...
You are iteratively building a timesheet application. Read CLAUDE.md for project conventions and USER_STORIES.md for the task list.

## Instructions

1. **Read USER_STORIES.md** and find the first story marked `- [ ]` (unchecked).
2. **Implement that story completely**, following the conventions in CLAUDE.md.
...
- Follow all conventions in CLAUDE.md (layered architecture, DTOs, test coverage, etc.).
